...
%subdir_pre='CTRL_icRCEold/';    %general subdir that includes multiple runs within
...
%subdir_pre='TRANSFER/';    %general subdir that includes multiple runs within
%subdir_pre='CAPE_VORTEX/';    %general subdir that includes multiple runs within
ext_hd = 1; %0=local hard drive; 1=external hard drive


subdir_axisym = 'CTRLv0qrhSATqdz5000_nx3072'; %name of sub-directory with nc files
t_file_axisym=99*4+1;  %file timestep
subdir_3d = 'RCE_nx48_SST300.00K_Tthresh175K_usfc3';  %name of sub-directory with nc files
t_file_3d=1;  %file timestep
...
%IF plot_type=1: input variable and domain
    ...
    pl_color='r--';
    var = 'pi';  %variable of interest (DRC vars: 'angmom')
 ...
 if(run_type==1 || run_type==10)   %axisym
    ...
    xf=20000;   %first y grid point [0,end]
...
figure(4)
pi_cm1 = data(:,1);
p_cm1 = 100000*(pi_cm1).^(1004/287.04);
plot(p_cm1,zz00')
hold on
plot(pp00',zz00','r')
[p_cm1(1) pp00(1)]
