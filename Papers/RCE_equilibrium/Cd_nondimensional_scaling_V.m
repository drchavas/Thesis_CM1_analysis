...
switch m
    case 1,
        ...
        text1=text(2,2.5,sprintf('$\\alpha_3 = $ %5.2f',exp_VmVp),'fontweight','bold','FontSize',24,'Color',clr1)
    ...
    case 2,
        ...
        text1=text(2,3.1,sprintf('$\\alpha_2 = $ %5.2f',exp_VmVp),'fontweight','bold','FontSize',24,'Color',clr2)
        set(text1,'HorizontalAlignment','center','VerticalAlignment','middle','Interpreter','Latex');    
    ...
    case 3,
        ...
        text1=text(2,3.7,sprintf('$\\alpha_1 = $ %5.2f',exp_VmVp),'fontweight','bold','FontSize',24,'Color',clr3)
        set(text1,'HorizontalAlignment','center','VerticalAlignment','middle','Interpreter','Latex');    
...
%print -dpdf -r300 Cd_Nondimensional_scaling_V.pdf
