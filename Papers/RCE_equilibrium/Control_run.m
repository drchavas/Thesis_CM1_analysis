...
%plot with Vmax, rmax, and r0 all on a single plot (i.e. a modified version
%of figure 1)
...
for i=1:1%numruns
    ...
    Vm_plot = Vmax_movave_g_all(:,i)/Vmax_equil_g(1);
...
%    end
    ...
    rm_plot = rmax_movave_g_all(:,i)/rmax_equil_g(1);
...
%    end
    ...
    r0_plot = r0Lil_movave_g_all(:,i)/r0Lil_equil_g(1);
