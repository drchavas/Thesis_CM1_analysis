%Fig8a_CkCd_nondimensional_scaling_V.m
...
L_temp = Vmax_equil_g_ts_min./mpi_all;
U_temp = Vmax_equil_g_ts_max./mpi_all;
...
print -dpdf -r300 Fig8a_CkCd_nondimensional_scaling_V.pdf
