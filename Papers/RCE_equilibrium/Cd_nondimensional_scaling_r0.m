%Cd_nondimensional_scaling_r0.m
...
switch m
    case 1,
        ...
        text1=text(2,2.5,sprintf('$\\alpha_3 = $ %5.2f',exp_r0Vpf),'fontweight','bold','FontSize',24,'Color',clr1)
...
%print -dpdf -r300 Cd_Nondimensional_scaling_r0.pdf
