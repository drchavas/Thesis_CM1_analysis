...
for m=1:length(sim_sets)
    ...
    load(sprintf('../CM1_postproc_data/simsets/%s.mat',sim_set));
...
%    subplot(3,1,1)
    if(m==1)
    ax1=axes('position',[0.15    0.72    0.70    0.26]);
    end
    axes(ax1)
...
%    subplot(3,1,2)
    if(m==1)
    ax2=axes('position',[0.15    0.43    0.70    0.26]);
    end
    axes(ax2)
...
%    subplot(3,1,3)
    if(m==1)
    ax3=axes('position',[0.15    0.14    0.70    0.26]);
    end
    axes(ax3)
