...
%    pl_clrs={'r' 'g' 'c' 'k' 'y' 'm' 'r--' 'g--' 'c--' 'k--' 'y--'};
    ...
    vmax_plot = 80; %highest value plotted
    plot_normalized = 0;    %1=plot V/Vmax, r/rmax; 0=plot regular V(r)
    r_ts = 0; %1=plot time series of r(v_usr) 0=don't
        v_usr = 14; %find radius of this wind speed; 'MAX' for V_max
        numpt_sm = 10;  %smoother uses this number of points
...
'CTRLv0qrhSATqdz5000_x4_dx8_ts16_lh1500'
...
'CTRLv0qrhSATqdz5000_dx32'
%}

%{
%%INDIVIDUAL LENGTH SCALES
'CTRLv0qrhSATqdz5000'
'CTRLv0qrhSATqdz5000_L768dx2'
'CTRLv0qrhSATqdz5000_L768nx192'
'CTRLv0qrhSATqdz5000_lh750'
'CTRLv0qro100000qrhSATqdz5000'
'CTRLv0qrhSATqdz5000_L768dx2_lh750'
'CTRLv0qrhSATqdz5000_L768dx2_qro100000'
'CTRLv0qrhSATqdz5000_L768nx192_lh750'
'CTRLv0qrhSATqdz5000_L768nx192_qro100000'
'CTRLv0qrhSATqdz5000_lh750_qro100000'
'CTRLv0qrhSATqdz5000_div2'
%}

%{
%%dz
'CTRLv0qrhSATqdz5000_dz312.5'
'CTRLv0qrhSATqdz5000'
'CTRLv0qrhSATqdz5000_dz1250'
%}
...
%%DOMAIN SIZE (nx)
'CTRLv0qrhSATqdz5000_div4'
'CTRLv0qrhSATqdz5000_div4_nx768'
'CTRLv0qrhSATqdz5000_div4_nx1536'
%}

%{
%%DOMAIN SIZE (nx) vs. self-similarity
'CTRLv0qrhSATqdz5000_div4'
'CTRLv0qrhSATqdz5000_div4_nx768'
'CTRLv0qrhSATqdz5000_div2'
'CTRLv0qrhSATqdz5000_div2_nx768'
'CTRLv0qrhSATqdz5000'
'CTRLv0qrhSATqdz5000_nx768'
'CTRLv0qrhSATqdz5000_x2'
%'CTRLv0qrhSATqdz5000_x2_nx768'
%'CTRLv0qrhSATqdz5000_x4'
%'CTRLv0qrhSATqdz5000_x4_nx768'
%'CTRLv0qrhSATqdz5000_x8'
%}
...
'CTRLv0qrhSATqdz5000_Tthresh150K_nz48_zd25'
%}

%{
%%Coriolis (f)
%doesntwork'CTRLv0qrhSATqdz5000_f0'
'CTRLv0qrhSATqdz5000_fdiv16'
'CTRLv0qrhSATqdz5000_fdiv8'
'CTRLv0qrhSATqdz5000_fdiv4'
'CTRLv0qrhSATqdz5000_fdiv2'
'CTRLv0qrhSATqdz5000'
'CTRLv0qrhSATqdz5000_fx2'
'CTRLv0qrhSATqdz5000_fx4'
'CTRLv0qrhSATqdz5000_fx8'
'CTRLv0qrhSATqdz5000_fx16'
%}

%{
%%UPPER BOUND ON SIZE I: Existence
'CTRLv0qrhSATqdz5000_x4_dx8_ts16_lh6000'
'CTRLv0qrhSATqdz5000_x8_dx8_ts16_lh6000'
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh6000'
'CTRLv0qrhSATqdz5000_x4_dx8_ts16_lh1500'
'CTRLv0qrhSATqdz5000_x8_dx8_ts16_lh1500'
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh1500'
%}

%{
%%UPPER BOUND ON SIZE II: Scaling with Vpot/f
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh1500'
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh1500_Tthresh150K_nz48_zd25000'
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh1500_Tthresh250K'
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh1500_fdiv2'
'CTRLv0qrhSATqdz5000_x16_dx8_ts16_lh1500_fx2'
'CTRLv0qrhSATqdz5000'
'CTRLv0qrhSATqdz5000_nx768'
'CTRLv0qrhSATqdz5000_Tthresh250K'
'CTRLv0qrhSATqdz5000_fx2'
...
%%LOWER BOUND
'CTRLv0qrhSATqdz5000_div8'
'CTRLv0qrhSATqdz5000_div8_lh0'
'CTRLv0qrhSATqdz5000_div16'
'CTRLv0qrhSATqdz5000_div16_lh0_short'
%'CTRLv0qrhSATqdz5000_div32_lh0_short'
%}
...
%    t_max_day = dt*i_tf/86400;
    ...
    %    axis([xmin_sub xmax_sub 0 Vmaxs(rr)])
        ...
        if(r_ts==1)
            ...
            plot(t_day(i_plot)',smooth(r_usr(i_plot)/rmaxs(rr),numpt_sm)',pl_clrs{rr},'LineWidth',2)
...
%        axis([xmin_sub xmax_sub vmin_plot vmax_plot])
        ...
        if(r_ts==1)
            ...
            figure(1)
            plot(t_day(i_plot)',smooth(r_usr(i_plot),numpt_sm)',pl_clrs{rr},'LineWidth',2)
...
%input_legend={'Control' '1.5*MPI' 'MPI/2' 'f/2' '2*f'}
legend(input_legend)
...
%%Calculate r0 using Lilly model for outer region
fcor = 5e-5;
[r_full,V_full,r_0_full,res_error] = r0_calc(r_usr_means(1),v_usr(1),fcor)

figure(2)
hold on
plot(r_full, V_full,'r')
r_0_full/1000
